...
//   		System.out.println(premium.toString());
   ...
   //find the book where price is greater than 12
    		    ...
    		    String jsonString = "{\n"
    		    	...
    		    	JSONObject store = js.getJSONObject("store");
    		    	JSONArray book = store.getJSONArray("book");
    		    	for(int i=0;i<book.length();i++)
    		    	{
    		    	     JSONObject jos1111 = book.getJSONObject(i);
    		    	     
    		    	 	Double price= jos1111.getDouble("price");
    		    	        String title= jos1111.getString("title");     
